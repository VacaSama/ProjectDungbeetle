...
public class Questionnaire
{
    ...
    /// </summary>
    public string QuestionText { get; set; } // What languages are you learning?, What is your experience level?
    ...
    /// </summary>
    public string QuestionType { get; set; } // Checkbox (checks all that apply)
